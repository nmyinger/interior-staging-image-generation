...
export const SourceNode = memo(function SourceNode({ id, data, selected }: NodeProps) {
  ...
  return (
    <div className={`relative bg-white border-2 ${selected ? "border-sage-400 ring-2 ring-sage-200" : "border-stone-200"} rounded-[var(--radius-node)] shadow-sm w-44 overflow-hidden group transition-[border-color,box-shadow]`}>
      {d.photoUrl ? (
